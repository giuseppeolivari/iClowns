            ...
            ZStack {
                ...
                VStack() {
                    ...
                    ZStack {
                        ...
                        Text("Stamps Obtained " + "\(countUnlocked(collectibles: popularBeliefs))" + " / " + "10")
                    ...
                    ZStack {
                        ...
                        Text("Stamps Obtained " + "\(countUnlocked(collectibles: entertainment))" + " / " + "10")
                            .foregroundStyle(Color.white)
                            .font(.footnote)
                            .padding(.leading, 240)
                    }
                    ...
                    ZStack {
                        ...
                        Text("Stamps Obtained " + "\(countUnlocked(collectibles: traditionsㅤㅤㅤ))" + " / " + "10")
                            .foregroundStyle(Color.white)
                            .font(.footnote)
                            .padding(.leading, 240)
                    }
