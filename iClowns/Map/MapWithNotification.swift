...
struct MapWithNotification: View {
        ...
        NavigationStack{
            Map(position: $cameraPosition, selection: $selectedTag) {
                ...
                Marker("Attraction", systemImage: "figure.wave", coordinate: .attrazione55.cordinata)
                    .tag(6)
               /* Marker("Attraction", systemImage: "figure.wave", coordinate: .attrazione66.cordinata)
                    .tag(7) */
                
                //    Annotation("",coordinate: .attrazione55, anchor: .bottom)   {
                //         Image(systemName: "figure.wave")
                //      }.tag(6)
                //          .onTapGesture(LocationDetailView(selectedTag: $selectedTag))
            ...
            /* NON VA BENE
             ...
             NavigationLink(destination: LocationDetailView(selectedTag: $selectedTag)){
             }
             }
             */
